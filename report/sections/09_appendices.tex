...
\begin{lstlisting}[language=Python, caption=Passport tags loading and generation of the PID-tags dictionary]
  import os
  import json
  import pandas as pd
...
\begin{lstlisting}[language=Python, caption=Keras and Keras Tuner snippet for model training and hyperparameter tuning]
...
\begin{lstlisting}[language=Python, caption=Binary cross-entropy loss visualisation]
...
% \begin{figure}[h]
%   \centering
%   \includegraphics[scale=0.5]{passport_file}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.5]{catalogue_size}
...
% \begin{figure}[h]
%   \centering
%   \includegraphics[scale=0.5]{dataset_encoded}
...
% \begin{figure}[h]
%   \centering
%   \includegraphics[scale=0.5]{program_hierarchy}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.5]{pids_added}
